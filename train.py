...
def get_args_parser():
    ...
    parser.add_argument('--resume', default='/home/zhangjiahua/Code/TransVG/checkpoints/checkpoints/unc_best_checkpoint.pth', help='resume from checkpoint')
    parser.add_argument('--detr_model', default='/home/zhangjiahua/Code/Pseudo-Q_old/saved_models/detr-r50.pth', type=str, help='detr model')
...
def main(args):
    ...
    # build dataset
    dataset_train = build_dataset('uni_modal', args)
